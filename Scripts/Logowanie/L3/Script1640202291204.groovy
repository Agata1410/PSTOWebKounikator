...
WebUI.scrollToElement(findTestObject('logowanie_edycja_Page_PSTO webMessenger/input_Zarejestruj konto_login'), 3)

WebUI.waitForElementClickable(findTestObject('logowanie_edycja_Page_PSTO webMessenger/input_Zarejestruj konto_login'), 3)
