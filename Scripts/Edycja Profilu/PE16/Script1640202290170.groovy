...
WebUI.click(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/div_Zarejestruj konto_icon'))

WebUI.click(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/img_Zarejestruj konto_profile'))

WebUI.selectOptionByValue(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/select_wiek'), '20', true)
...
wiek = WebUI.getAttribute(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/select_wiek'), 'value')
