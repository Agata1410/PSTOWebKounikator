...
WebUI.scrollToElement(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/select_plec'), 2)

WebUI.selectOptionByValue(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/select_plec'), '1', true)
...
plec = WebUI.getAttribute(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/select_plec'), 'value')
