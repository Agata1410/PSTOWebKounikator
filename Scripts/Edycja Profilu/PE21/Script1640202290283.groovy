...
WebUI.scrollToElement(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/input_Pe_editWww'), 2)

WebUI.setText(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/input_Pe_editWww'), 'https://www.wp.pl/')
...
value_text = WebUI.getAttribute(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/input_Pe_editWww'), 'value')
