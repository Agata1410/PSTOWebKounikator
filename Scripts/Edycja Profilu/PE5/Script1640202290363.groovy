...
zmienna1 = WebUI.getText(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/p_Nie wypeniono wszystkich pol Podane Hasla ronzia sie'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyMatch(zmienna1, 'NIE WYPEŁNIONO WSZYSTKICH PÓL!.*', true)
