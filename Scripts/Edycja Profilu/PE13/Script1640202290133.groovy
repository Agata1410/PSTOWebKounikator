...
WebUI.scrollToElement(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/input_Zmien dane_editMiasto'), 2)

WebUI.setText(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/input_Zmien dane_editMiasto'), 'Poznań')
...
value_text = WebUI.getAttribute(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/input_Zmien dane_editMiasto'), 'value')

WebUI.verifyEqual('Poznań', value_text)
