...
WebUI.setText(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/input_Zmien dane_editName'), 'Ewa')
...
value_text = WebUI.getAttribute(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/input_Zmien dane_editName'), 'value')

WebUI.verifyEqual('Ewa', value_text)
