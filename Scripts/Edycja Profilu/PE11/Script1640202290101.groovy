...
WebUI.setText(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/input_Zmien dane_editMail'), 'ewelina.holderna@gmail.com')
...
value_text = WebUI.getAttribute(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/input_Zmien dane_editMail'), 'value')

WebUI.verifyMatch(value_text, '^[\\w-\\.]+@([\\w-]+\\.)+[\\w-]{2,4}$', true)
