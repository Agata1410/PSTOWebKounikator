...
WebUI.setEncryptedText(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/input_Zmien haslo_editPass'), 'iGDxf8hSRT4=')
...
WebUI.verifyElementText(findTestObject('logowanie_edycja_Page_PSTO webMessenger - Zalogowano/p_Podane dotychczasowe haslo jest bledne'), 
