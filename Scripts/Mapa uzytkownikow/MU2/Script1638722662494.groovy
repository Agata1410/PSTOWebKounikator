...
WebUI.rightClick(findTestObject('Object Repository/Page_PSTO webMessenger - Zalogowano/div'))

WebUI.rightClick(findTestObject('Object Repository/Page_PSTO webMessenger - Zalogowano/div'))

WebUI.rightClick(findTestObject('Object Repository/Page_PSTO webMessenger - Zalogowano/img'))
