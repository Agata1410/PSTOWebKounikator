...
WebUI.setText(findTestObject('Object Repository/Page_PSTO webMessenger/input_Zarejestruj konto_userLogin'), 'Ameba2')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_PSTO webMessenger/input_Zarejestruj konto_passwordLogin'), 
    'myv0lBmsSyT1Gjw3iFsd+w==')
...
WebUI.click(findTestObject('Object Repository/Page_PSTO webMessenger - Zalogowano/div_11399                                  _09097b'))

WebUI.click(findTestObject('Object Repository/Page_PSTO webMessenger - Zalogowano/img_aaaaaaaaaaaaaaaaaaaaaaaa aaaaaaaa_starF_13df63'))
...
WebUI.click(findTestObject('Object Repository/Page_PSTO webMessenger - Zalogowano/img_Zarejestruj konto_iconImg_1_2'))
